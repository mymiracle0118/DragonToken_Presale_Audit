...
[![Gitter chat](https://badges.gitter.im/sc-forks/hardhat-coverage.svg)][18]
![npm (tag)](https://img.shields.io/npm/v/hardhat-coverage/latest)
[![CircleCI](https://circleci.com/gh/sc-forks/hardhat-coverage.svg?style=svg)][20]
[![codecov](https://codecov.io/gh/sc-forks/hardhat-coverage/branch/master/graph/badge.svg)][21]
...
+ `hardhat-coverage` is [Solcover][17]
...
hardhat-coverage's core methods and many utilities are available as an API.

```javascript
const CoverageAPI = require('hardhat-coverage/api');
```

[Documentation available here][28].

## Detecting hardhat-coverage from another task
...
```
$ git clone https://github.com/sc-forks/hardhat-coverage.git
$ yarn
```
...
[4]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#running-out-of-gas
[5]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#running-out-of-memory
[6]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#running-out-of-time
[7]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#continuous-integration
[8]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#notes-on-branch-coverage
[9]: https://sc-forks.github.io/metacoin/
[10]: https://coveralls.io/github/OpenZeppelin/openzeppelin-solidity?branch=master
[11]: https://github.com/sc-forks/hardhat-coverage/tree/master/test/units
[12]: https://github.com/sc-forks/hardhat-coverage/issues
[13]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#notes-on-gas-distortion
[14]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/advanced.md
[15]: #config-options
[16]: https://blog.colony.io/code-coverage-for-solidity-eecfa88668c2
[17]: https://github.com/JoinColony/solcover
[18]: https://gitter.im/sc-forks/hardhat-coverage?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
[19]: https://badge.fury.io/js/hardhat-coverage
[20]: https://circleci.com/gh/sc-forks/hardhat-coverage
[21]: https://codecov.io/gh/sc-forks/hardhat-coverage
[22]: https://cdn-images-1.medium.com/max/800/1*uum8t-31bUaa6dTRVVhj6w.png
[23]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/advanced.md#workflow-hooks
[24]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/advanced.md#skipping-tests
[25]: https://github.com/sc-forks/hardhat-coverage/issues/417
[26]: https://buidler.dev/
[27]: https://www.trufflesuite.com/docs
[28]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/api.md
[29]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/upgrade.md#upgrading-from-06x-to-070
[30]: https://github.com/sc-forks/hardhat-coverage/tree/0.6.x-final#hardhat-coverage
[31]: https://github.com/sc-forks/hardhat-coverage/releases/tag/v0.7.0
[32]: https://github.com/sc-forks/buidler-e2e/tree/coverage
[33]: https://github.com/sc-forks/moloch
[34]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/advanced.md#reducing-the-instrumentation-footprint
...
[37]: https://github.com/sc-forks/hardhat-coverage/blob/master/HARDHAT_README.md
[38]: https://github.com/sindresorhus/globby#globbing-patterns
[39]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/advanced.md#generating-a-test-matrix
[1001]: https://docs.soliditylang.org/en/v0.8.0/using-the-compiler.html#input-description
[1002]: https://github.com/sc-forks/hardhat-coverage/blob/master/docs/faq.md#running-out-of-stack
